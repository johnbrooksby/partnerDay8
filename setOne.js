...
const prob2 = (par1, par2) => (`The first parameter is ${par1}.  The second parameter is ${par2}.`);


// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

console.log(prob2("three", 2));
...
console.log(`Hello, my full name is ${greeting("John", "Brooksby", concat)}.`);
